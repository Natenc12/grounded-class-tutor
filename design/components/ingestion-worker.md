...
- **In — job queue (ADR 0011):** the worker **claims** a job (at-least-once; a lease/reaper reclaims a
  ...
  lease while it works, ADR 0028, the lease's meaning amended per ADR 0031). Processing is
